/**
 *  Xiaomi Honeywell Zigbee Smoke Detector
 *
 *
 ...
 *
 *  Based on original DH by Kenneth Evers
 *
 *  Change log:
 *  Inpier - Added Battery Level and Smoke Alarm Last Tested. (Note both these are best guess from live logging data received.)
 */

metadata {
	definition (name: "Xiaomi Honeywell Smoke Detector", namespace: "bspanger", author: "bspanger") {
	...
	tiles(scale: 2) {
		...
		standardTile("lastTested", "", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
		...
		main (["smoke"])
		details(["smoke","configure","refresh"])
	}
}
